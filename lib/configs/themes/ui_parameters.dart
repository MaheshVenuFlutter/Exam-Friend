...
final kMobileScreenPadding = Dimensions.height10;
...
class UIParameters {
  ...
  static EdgeInsets get screenPadding => EdgeInsets.all(kMobileScreenPadding);
  ...
  static bool isDarkMode() {
    return Get.isDarkMode
        ? true
        : false; //Theme.of(context).brightness == Brightness.dark;
  }
