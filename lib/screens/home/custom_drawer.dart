                      ...
                      ? TextButton.icon(
                          ...
                          style: TextButton.styleFrom(
                              padding: EdgeInsets.symmetric(
                                  ...
                                  horizontal: Dimensions.height15), //10,15
                              elevation: 0,
                          ...
                          child: Align(
                            ...
                            child: Padding(
                              padding: EdgeInsets.only(
                                  ...
                                  bottom: Dimensions.height10), //t12,b10
                              child: CircleAvatar(
                                foregroundImage:
                                ...
                                radius: Dimensions.radious40, //40
                              ),
                            ),
                          ),
                        )),
                    ...
                    () => controller.user.value == null
                        ...
                        : Text(controller.user.value!.displayName ?? '',
                            style: TextStyle(
                                ...
                                fontSize: Dimensions.fontSize18, //18
                                color: kOnSurfaceTextColor)),
                  ),
                  const Spacer(flex: 1),
                  _DrawerButton(
                      ...
                      onPressed: () {}),
                  Padding(
                    padding: EdgeInsets.only(left: Dimensions.height25), //25
                    child: Column(
